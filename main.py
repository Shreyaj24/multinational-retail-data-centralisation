...
if __name__ == "__main__":    
    ...
    datacon.upload_to_db(data_clean_pd, "dim_users3")
    ...
    datacon.upload_to_db(clean_card_det, "dim_card_details3")
    ...
    datacon.upload_to_db(clean_store_data, "dim_store_details3")
    ...
    datacon.upload_to_db(com_clean_products_df, "dim_products3")
    ...
    datacon.upload_to_db(clean_ord_df, "orders_table3")
    ...
    datacon.upload_to_db(clean_date_df, "dim_date_times3")